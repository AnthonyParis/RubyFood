...
sushi = Restaurant.new(name: "Sushi World", address: "12 Rue du Japon", rate: 4.5)
sushi.save
...
pizza = Restaurant.new(name: "Super Pizza", address: "12 Rue du Fromage", rate: 4.0)
pizza.save
...
burger = Restaurant.new(name: "Little Burger", address: "27 Rue de la Légion d'Honneur, 75019 Paris", rate: 4.0)
burger.save
